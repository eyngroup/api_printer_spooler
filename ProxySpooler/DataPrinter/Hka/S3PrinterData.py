      ...
      if (len(trama) > 0):
        try:
          ...
          if (len(_arrayParameter) > 1):
            ...
            self._setTax1(Util().do_value_double(_arrayParameter[0][3:]))
            self._setTypeTax2(_arrayParameter[1][0])          
            self._setTax2(Util().do_value_double(_arrayParameter[1][1:]))
            self._setTypeTax3(_arrayParameter[2][0])          
            self._setTax3(Util().do_value_double(_arrayParameter[2][1:]))
