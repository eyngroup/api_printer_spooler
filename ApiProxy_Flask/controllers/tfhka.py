# ESTA LIBRERÍA TIENE TODAS LAS CLASES INTERNAS
...
class tf_ve_ifpython:
    ...
    def OpenFpctrl(self, p):
        if not self.bandera:
            try:
                self.ser = serial.Serial(port=p, baudrate=self.Port.baudRate, bytesize=self.Port.dataBits,
                                         parity=self.Port.parity, stopbits=self.Port.stopBits,
                                         timeout=self.Port.readTimeOut, writeTimeout=self.Port.writeTimeOut,
    ...
    def _GetStatusError(self, st, er):
        ...
        if (
                st & 0x6A) == 0x6A:  # En modo fiscal, carga completa de la memoria fiscal y emisi�n de documentos no fiscales
            self.status = 'En modo fiscal, carga completa de la memoria fiscal y emisi�n de documentos no fiscales'
            status = "12"
        elif (
                st & 0x69) == 0x69:  # En modo fiscal, carga completa de la memoria fiscal y emisi�n de documentos  fiscales
            ...
            status = "10"
                ...
                st & 0x72) == 0x72:  # En modo fiscal, cercana carga completa de la memoria fiscal y en emisi�n de documentos no fiscales
            self.status = 'En modo fiscal, cercana carga completa de la memoria fiscal y en emisi�n de documentos no fiscales'
            status = "9 "
        elif (
                st & 0x71) == 0x71:  # En modo fiscal, cercana carga completa de la memoria fiscal y en emisi�n de documentos no fiscales
            self.status = 'En modo fiscal, cercana carga completa de la memoria fiscal y en emisi�n de documentos no fiscales'
            status = "8 "
...
class Tfhka(tf_ve_ifpython):
    ...
    def PrintZReport(self, *items):  # (self, mode, startParam, endParam):
        if (len(items) > 0):
            ...
            if (type(startParam) == datetime.date and type(
                    endParam) == datetime.date):  # if(type(startParam)==int and (type(endParam)==int)):
                starString = startParam.strftime("%d%m%y")
                endString = endParam.strftime("%d%m%y")
    ...
    def __init__(self, trama):
                ...
                try:
                    ...
                    while (_iteration < _flagsQuantity):
                        self._systemFlags.append(
                            str(_arrayParameter[0][24:152][_index: _index + 2]))  # _index, 2 #[_iteration]
                        _index = _index + 2
                        _iteration += 1
        ...
        if (len(trama) == 156):  # TRAMA CON FLAGS 63-16,17,18,19
            try:
                ...
                while (_iteration < _flagsQuantity):
                    self._systemFlags.append(
                        str(_arrayParameter[0][31:159][_index: _index + 2]))  # _index, 2 #[_iteration]
                ...
                try:
                    ...
                    while (_iteration < _numberOfMeansOfPayment):
                        ...
                        if (_iteration < 0):
                            ...
                            _valor = _cadena
                        self._allMeansOfPayment += "\nMedio de Pago " + str(_iteration + 1) + " : " + str(
                            Util().DoValueDouble(_valor[3:21]))
                        ...
                        self._allMeansOfPayment += "\nMedio de Pago 6 "" : " + str(
                            Util().DoValueDouble(_valor[103:121]))
                        self._allMeansOfPayment += "\nMedio de Pago 7 "" : " + str(
                            Util().DoValueDouble(_valor[123:141]))
                        self._allMeansOfPayment += "\nMedio de Pago 8 "" : " + str(
                            Util().DoValueDouble(_valor[143:161]))
                        self._allMeansOfPayment += "\nMedio de Pago 9 "" : " + str(
                            Util().DoValueDouble(_valor[163:181]))
                        self._allMeansOfPayment += "\nMedio de Pago 10 "" : " + str(
                            Util().DoValueDouble(_valor[183:201]))
                        self._allMeansOfPayment += "\nMedio de Pago 11 "" : " + str(
                            Util().DoValueDouble(_valor[203:221]))
                        self._allMeansOfPayment += "\nMedio de Pago 12 "" : " + str(
                            Util().DoValueDouble(_valor[223:241]))
                        self._allMeansOfPayment += "\nMedio de Pago 13 "" : " + str(
                            Util().DoValueDouble(_valor[243:261]))
                        self._allMeansOfPayment += "\nMedio de Pago 14 "" : " + str(
                            Util().DoValueDouble(_valor[263:281]))
                        self._allMeansOfPayment += "\nMedio de Pago 15 "" : " + str(
                            Util().DoValueDouble(_valor[283:301]))
                        self._allMeansOfPayment += "\nMedio de Pago 16 "" : " + str(
                            Util().DoValueDouble(_valor[303:321]))
                        self._allMeansOfPayment += "\nMedio de Pago 17 "" : " + str(
                            Util().DoValueDouble(_valor[323:341]))
                        self._allMeansOfPayment += "\nMedio de Pago 18 "" : " + str(
                            Util().DoValueDouble(_valor[343:361]))
                        self._allMeansOfPayment += "\nMedio de Pago 19 "" : " + str(
                            Util().DoValueDouble(_valor[363:381]))
                        self._allMeansOfPayment += "\nMedio de Pago 20 "" : " + str(
                            Util().DoValueDouble(_valor[383:401]))
                        self._allMeansOfPayment += "\nMedio de Pago 21 "" : " + str(
                            Util().DoValueDouble(_valor[403:421]))
                        self._allMeansOfPayment += "\nMedio de Pago 22 "" : " + str(
                            Util().DoValueDouble(_valor[423:441]))
                        self._allMeansOfPayment += "\nMedio de Pago 23 "" : " + str(
                            Util().DoValueDouble(_valor[443:461]))
                        self._allMeansOfPayment += "\nMedio de Pago 24 "" : " + str(
                            Util().DoValueDouble(_valor[463:481]))
                        _iteration += 1
            ...
            try:
                ...
                while (_iteration < _numberOfMeansOfPayment):
                    ...
                    if (_iteration < 0):
                        ...
                        _valor = _cadena
                    self._allMeansOfPayment += "\nMedio de Pago " + str(_iteration + 1) + " : " + str(
                        Util().DoValueDouble(_valor[3:16]))
