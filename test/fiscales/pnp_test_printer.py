...
def pf_reset():
    """
    Como medida de seguridad y para garantizar el control total del equipo por parte del Host,
    el controlador fiscal puede ser reiniciado vía software (llevado a condición de reset).
    """
...
def pf_status_if():
    """
    Este comando es utilizado para evaluar el estado del controlador fiscal. Mas informacion en la seccion COMANDOS DE CONTROL FISCAL del archivo readme.md
    """
...
def pf_serial():
    """
    Este comando es utilizado para los seriales del equipos
    """
    # [STX]E[128][ETX]00CA
...
def pf_document_cancel():
    """
    Este comando es utilizado para cancelar un documento fiscal si hay error
    """
...
def pf_paper_cut():
    """
    Este comando es utilizado para el corte de papel
    """
    # [STX]EK[ETX]0085
...
def pf_paper_feed():
    """
    Este comando es utilizado para avanzar el papel
    """
...
def pf_header_footer():
    """
    Este comando almacena una línea de datos fijos que aparece en el encabezado o pie de página de las facturas fiscales.
    Se permite hasta un máximo de 2 líneas para el encabezado y para el pie de página.
    """
...
def pf_barcode():
    """
    Generate and print a barcode on the fiscal printer.
    This command (0x54) generates a numeric barcode with the specified content.
    """
