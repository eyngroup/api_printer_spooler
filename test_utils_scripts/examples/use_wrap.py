...
if __name__ == "__main__":
    ...
    prefijo = ""  # Prefijo para cada línea
    ...
    print("--------------------------------------------------")
    """Metodo wrap(), toma un texto y lo divide en una lista de líneas.
    Cada una con una longitud máxima especificada. No divide las palabras"""
    ...
    print("--------------------------------------------------")
    """Metodo fill(), funciona como wrap(), pero en lugar de devolver una lista de líneas, 
    devuelve una sola cadena con líneas separadas por saltos de línea (\n)."""
    ...
    print("--------------------------------------------------")
    """Se puede personalizar el comportamiento de wrap() y fill() usando argumentos 
